...
export default function SchedulingView() {
  ...
  const renderCalendarContent = () => {
    if (viewMode === "today") {
      ...
      const isTimeInRange =
        currentTotalMinutes >= startHour * 60 &&
        currentTotalMinutes <= endHour * 60;
      const liveTimelinePosition = isTimeInRange
        ? (currentTotalMinutes - startHour * 60) * pixelsPerMinute
        : null;
            ...
            <div className="relative" style={{ height: `${timelineHeight}px` }}>
              {timeSlots.map((slot, idx) => {
                ...
                const shouldShowLabel =
                  slot.minutes >= startHour * 60 &&
                  slot.minutes <= endHour * 60;
                return (
                  <div
                    key={idx}
