  ...
  const handleEditClient = async (clientData) => {
    try {
      ...
      if (result.success) {
        ...
        setEditingClient(clientData); // Keep editingClient set to the updated client
        // setIsAddModalOpen(false); // Removed to keep modal open
          ...
          const authorizations = Array.isArray(client.authorizations)
            ? client.authorizations.map((auth) => {
                ...
                return {
                  ...
                  units_serviced: auth.units_serviced || "", // Ensure field is present
                  balance_units: balance.toString(), // Calculate balance
                };
              })
            : [];
