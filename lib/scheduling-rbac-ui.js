...
/** Create appointments on past clinic calendar days (America/Chicago). */
export function allowsSchedulingCreatePastSession(canAny) {
  return canAny([PERM.SCHEDULING_SESSION_CREATE_PAST]);
}
