...
const PERM_KEY_MATRIX_LABEL = {
  ...
  "clients.update": "Edit",
  "scheduling.session.create_past": "Create past-date sessions",
  "billing.sftp": "Office Ally SFTP submit",
  "view.reports_session_log": "Session Log",
  "view.reports_session_log_billing": "Session Log-Billing",
  "view.reports_session_import": "Session Import",
  "view.reports_insurance_utilization": "Insurance Utilization",
  "view.reports_mileage": "Mileage",
  "view.mileage_rate": "Mileage Rate",
  "manage_data.mileage_rate": "Mileage Rate",
};
