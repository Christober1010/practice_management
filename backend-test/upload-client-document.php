...
$possiblePaths = [
    __DIR__ . '/drive_helper.php',  // Local copy in backend-test folder
    __DIR__ . '/backend/drive_helper.php', // When this script is deployed at project root (prod layout)
    dirname(__DIR__) . '/backend-test/drive_helper.php', // When deployed from inside /backend-test
...
$vendorPaths = [
    __DIR__ . '/vendor/autoload.php',  // Local vendor folder in mahaverse-backend-test
