...
function cms1500_fill_location_billing_from_facility(array $loc): array
{
    $pairs = [
        ...
        // Box 33a often left blank for single-site orgs — reuse Box 32a.
    ...
    foreach ($sessions as $s) {
        ...
        $lines[] = [
            ...
            'rendering_provider_npi' => $provider
                ? (cms1500_normalize_npi($provider['npiNumber'] ?? '') ?: null)
                : null,
            'source' => [
                'type' => 'session',
                'id' => (int)$s['session_id'],
    ...
    $payload = [
        ...
        'rendering_provider' => [
            ...
            'npi' => $renderingProvider
                ...
                : cms1500_normalize_npi($firstSession['provider_npi'] ?? ''),
        ],
        'signing_provider' => [
