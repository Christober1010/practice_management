<?php
/**
 * One-shot: widen users.role to VARCHAR(64) so biller/planner/client persist.
...
try {
    ...
    echo json_encode([
        ...
        "note" => "Delete migrate-users-role.php after confirming. Re-save any user roles that still show —.",
    ]);
